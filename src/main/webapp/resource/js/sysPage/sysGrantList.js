    ...
    oTableInit.Init = function () {
	    $('#table').bootstrapTable({
	        ...
	        },
	        {
	            ...
	            width	: '120',
	            formatter: function (value, row, index) {
	            	return '<div style="width:110px;"><button class="btn btn-primary btn-xs" href="#" onclick="update(\'' + row.userId + '\',\'' + row.roleId + '\')"><i class="glyphicon glyphicon-pencil" aria-hidden="true"></i>修改</button> '
	            	+ '<button class="btn btn-danger btn-xs" onclick="del(\'' + row.userId + '\',\'' + row.roleId + '\')"><i class="glyphicon glyphicon-remove" aria-hidden="true"></i>删除</button></div>';
	            } 
	        }]
	    });
    };
